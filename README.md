...
感谢对本项目贡献的同学（排名按照commit先后顺序）：Trinkle23897（翁家翌，2016）、LJSthu（刘家硕，2016）、……以及电脑前的你！
...
- 大三下： 操作系统  存储技术基础  多媒体技术  机器学习概论  计算机网络专题训练  计算机系统结构  模式识别  数据库专题训练  数据挖掘  数学实验  数值分析  数字图像处理  现代密码学
- 大三小学期： 并行计算机体系结构与编程
- 大四上： 网络安全工程与实践
